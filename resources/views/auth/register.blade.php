...
<head>
  ...
  <title>Daftar | Portal Supplier - PT Krama Yudha Tiga Berlian</title>
    ...
    <div class="login-card">
      ...
      <form action="{{ route('register') }}" method="POST">
        ...
        <div style="margin-top: 15px;">
          <span class="form-text">Sudah punya akun?
            <a href="{{ route('login') }}" style="color: #b40000; text-decoration: none; font-weight: 600;">Login di sini</a>
          </span>
        </div>
      </form>
