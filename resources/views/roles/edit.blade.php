        ...
        <div class="flex-1 px-2 w-full md:w-1/2">
            <div class="bg-white rounded-lg shadow-md overflow-hidden border-l-4 border-yellow-500">
                <div class="bg-yellow-500 text-white px-6 py-4">
                    <h3 class="font-semibold text-lg"><i class="fas fa-edit mr-2"></i> Edit Role: {{ $role->name }}</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('roles.update', $role->id) }}" method="POST" novalidate>
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-500 @error('description') border-red-500 @enderror"
                        ...
                        <div class="mb-4">
                            ...
                            <p>
                                <span class="inline-block bg-cyan-600 text-white px-3 py-1 rounded-full text-sm font-semibold">{{ $role->users()->count() }} user</span>
                            </p>
                        </div>
                    </div>
                    <!-- /.card-body -->
